 ...
 ***********************************/
  ...
  *
  * - "Trbvh": High quality similar to Sbvh but with fast build performance. The Trbvh builder uses about 2.5 times the size of the final BVH for scratch space. A CPU-based Trbvh builder that does not have the memory constraints is available. OptiX includes an optional automatic fallback to the CPU version when out of GPU memory. See details in section 3.5 of the Programming Guide.
  *
  * - "MedianBvh": This builder is now internally remapped to Trbvh.
  *
  * - "Lbvh": This builder is now internally remapped to Trbvh.
  *
  * - "TriangleKdTree": This builder is now internally remapped to Trbvh.
  *
  * @param[in]   acceleration   The acceleration structure handle
  ...
  * <B>Description</B>
  *
  * @ref rtAccelerationSetTraverser is no longer used in OptiX 4.0. The traverser is selected automatically 
  * by OptiX internally. Applications that use this function will still work, but it will have no effect. 
  *
  * @param[in]   acceleration   The acceleration structure handle
  ...
  * currently used in the acceleration structure \a acceleration. 
  * \a return_string will be set to point to the returned
  ...
  *
  * <B>Functionality has changed in OptiX 4.0</B>
  *
  * @ingroup AccelerationStructure
  *
  * <B>Description</B>
  *
  * @ref rtAccelerationGetData retrieves some minimal state of the \a acceleration object,
  ...
  * @ref rtAccelerationGetData no longer saves the acceleration structure itself, but only saves the 
  * builder and properties. Applications using  @ref rtAccelerationGetData will still be functionally
  * correct as before, but when restoring the data with @ref rtAccelerationSetData, the structure will 
  * be rebuilt from scratch internally.
  *
  ...
  * <B>Description</B>
  *
  * @ref rtAccelerationSetData sets some minimal state of the \a acceleration
  * object, including builder type and properties, as
  ...
  * acceleration structure handle. @ref rtAccelerationSetData does not set the
  * data comprising the acceleration structure itself. The acceleration structure
  * will be rebuilt from scratch internally.
  *
